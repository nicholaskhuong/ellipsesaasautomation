...
public class DeleteLeaveRequest_DeleteApproveData_Step04 extends BaseTestCase {
	...
	public void selectPROCLeaveTransaction() {
		...
		Assert.assertEquals(leaveStartDate.get(index).getAttribute("value"),"2016-06-04");
