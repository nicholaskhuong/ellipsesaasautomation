...
public class StockCount_ConfirmSOH_SAB_Yes_CountSheetTypeDetailed_Steps02_05 extends BaseTestCase {
	...
	public void showCountActivites() {
		...
		Assert.assertEquals(stockCode.get(0).getAttribute("value"), "STC40");
		Assert.assertEquals(description.get(0).getAttribute("value"), "STOCK CODE;");
		Assert.assertEquals(stockOnHand.get(0).getAttribute("value"), "100");
		
    	Assert.assertEquals(bin.get(4).getAttribute("value"), "BIN2");
		Assert.assertEquals(stockCode.get(4).getAttribute("value"), "STC40");
		Assert.assertEquals(description.get(4).getAttribute("value"), "STOCK CODE;");
		Assert.assertEquals(stockOnHand.get(2).getAttribute("value"), "120");
		
    	Assert.assertEquals(bin.get(6).getAttribute("value"), "BIN3");
		Assert.assertEquals(stockCode.get(6).getAttribute("value"), "STC40");
		Assert.assertEquals(description.get(6).getAttribute("value"), "STOCK CODE;");
		Assert.assertEquals(stockOnHand.get(3).getAttribute("value"), "80");
	}
	...
	public void showCountActivityDetails() {
		...
		Assert.assertEquals(driver.findElement(By.id(CountActivitiesDetaiksPageDefinition.BIN_SOH_ID)).getAttribute("value"), "100");
		Assert.assertEquals(driver.findElement(By.id(CountActivitiesDetaiksPageDefinition.STOCKTAKE_NUMBER_ID)).getAttribute("value"), "001788");
	}
