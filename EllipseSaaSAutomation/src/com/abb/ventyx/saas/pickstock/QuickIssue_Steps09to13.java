...
public class QuickIssue_Steps09to13 extends BaseTestCase {
	...
	public void showPickTasksDetails() {
		...
		WebElement closeAction = driver.findElement(By
				.cssSelector("#closeAction2 > span > span"));
		WebElement partialPickAction = driver.findElement(By
				.cssSelector("#issueAction > span > span"));
	...
	public void displayClosePickTaskSreen() {
		...
		// "Close Pick Task"); Still error
		Assert.assertEquals(
				driver.findElement(By.cssSelector("#closureComment"))
						.getAttribute("value"), "");
	}
	...
	public void clickBackNavigationButton() throws Throwable {
		waitAction.waitObjVisible(driver,
				By.xpath("(//div[@id='backNavigation']/span)[2]"), 3);
		driver.findElement(By.xpath("(//div[@id='backNavigation']/span)[2]"))
				.click();
		// Assert.assertEquals(driver.findElement(By.xpath("//*[@id='saas-3522304']/div/div[2]/div/div[2]/div/div[1]/div[1]/span")).getText(),
		// "Pick Task Details"); Still error
	}
