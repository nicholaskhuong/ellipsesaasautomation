...
public class IssueStockSearchbyRequisitionNumbers_Step02 extends BaseTestCase {
	...
	public void showPickasks() {
		...
		Assert.assertEquals(documentNumber.get(0).getAttribute("value"),"A00244");
		...
		Assert.assertEquals(documentNumber.get(1).getAttribute("value"),"C00009");
		...
		Assert.assertEquals(documentNumber.get(2).getAttribute("value"),"C01002");
		Assert.assertEquals(documentItemNumber.get(2).getAttribute("value"),"0003");
		Assert.assertEquals(isStockItemComplexManaged.get(2).getAttribute("value"),"No");
		...
		Assert.assertEquals(documentNumber.get(3).getAttribute("value"),"D00326");
		Assert.assertEquals(documentItemNumber.get(3).getAttribute("value"),"0001");
		Assert.assertEquals(isStockItemComplexManaged.get(3).getAttribute("value"),"No");
		...
		Assert.assertEquals(documentNumber.get(4).getAttribute("value"),"E00221");
		Assert.assertEquals(documentItemNumber.get(4).getAttribute("value"),"0001");
		Assert.assertEquals(isStockItemComplexManaged.get(4).getAttribute("value"),"No");
		...
		Assert.assertEquals(documentNumber.get(5).getAttribute("value"),"E00650");
		Assert.assertEquals(documentItemNumber.get(5).getAttribute("value"),"0002");
