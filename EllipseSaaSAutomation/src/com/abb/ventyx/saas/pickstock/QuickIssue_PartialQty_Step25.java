...
public class QuickIssue_PartialQty_Step25 extends BaseTestCase {
	...
	@Test(description = "Input value in Pick Task Details", dependsOnMethods = "showPickTaskDetails", alwaysRun = true)
	public void inputValueInPickTaskDetails() {
		driver.findElement(By.id(PickTasksDetailsPageDefinition.QUANTITY_PICKED_ID)).clear();
		driver.findElement(By.id(PickTasksDetailsPageDefinition.QUANTITY_PICKED_ID)).sendKeys("20");
	...
	@Test(description = "Click PICK Button", dependsOnMethods = "inputValueInPickTaskDetails", alwaysRun = true)
