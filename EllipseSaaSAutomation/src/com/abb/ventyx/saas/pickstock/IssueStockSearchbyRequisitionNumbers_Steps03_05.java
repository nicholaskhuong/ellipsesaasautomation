...
public class IssueStockSearchbyRequisitionNumbers_Steps03_05 extends
		BaseTestCase {
	...
	public void inputValueOnPickTasksSettingPage() throws Throwable {
		...
		// Assert.assertEquals(driver.findElement(By.xpath("//*[@id='saas-3522304']/div/div[2]/div/div[2]/div/div[1]/div[1]/span")).getText(),
		// "Settings"); Still error
	}
	...
	public void showPickTasksType() {
		...
		Assert.assertEquals(documentItemNumber.get(2).getAttribute("value"),
				"0002");
		Assert.assertEquals(
				isStockItemComplexManaged.get(2).getAttribute("value"), "Yes");
		...
		Assert.assertEquals(documentNumber.get(6).getAttribute("value"),
				"Y00852");
		Assert.assertEquals(documentItemNumber.get(6).getAttribute("value"),
				"0001");
		Assert.assertEquals(
				isStockItemComplexManaged.get(6).getAttribute("value"), "Yes");
		...
		Assert.assertEquals(documentNumber.get(7).getAttribute("value"),
				"D00326");
		Assert.assertEquals(documentItemNumber.get(7).getAttribute("value"),
				"0001");
		Assert.assertEquals(
				isStockItemComplexManaged.get(7).getAttribute("value"), "No");
		...
		Assert.assertEquals(documentNumber.get(8).getAttribute("value"),
				"F00454");
		Assert.assertEquals(documentItemNumber.get(8).getAttribute("value"),
				"0001");
		Assert.assertEquals(
				isStockItemComplexManaged.get(8).getAttribute("value"), "Yes");
		...
		Assert.assertEquals(documentNumber.get(9).getAttribute("value"),
				"G00032");
		Assert.assertEquals(documentItemNumber.get(9).getAttribute("value"),
				"0003");
		Assert.assertEquals(
				isStockItemComplexManaged.get(9).getAttribute("value"), "Yes");

		Assert.assertEquals(stockCode.get(10).getAttribute("value"),
				"000005678");
		...
		Assert.assertEquals(documentNumber.get(10).getAttribute("value"),
				"J00649");
		Assert.assertEquals(documentItemNumber.get(10).getAttribute("value"),
				"0001");
		Assert.assertEquals(
				isStockItemComplexManaged.get(10).getAttribute("value"), "No");
	}
