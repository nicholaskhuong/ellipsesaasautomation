...
public class QuickIssue_PartialQty_Step06 extends BaseTestCase {
	...
	public void showPickTasks() {
		...
		screenAction.assertButtonEnabled(By.id(PickTasksPageDefinition.CLOSE_BUTTON_ID), 1, false);
		screenAction.assertButtonEnabled(By.id(PickTasksPageDefinition.PARTIAL_PICK_BUTTON_ID), 1, false);
		screenAction.assertButtonEnabled(By.id(PickTasksPageDefinition.FULL_PICK_BUTTON_ID), 1, false);
