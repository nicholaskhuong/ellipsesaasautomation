...
public class QuickIssue_Step08 extends BaseTestCase {
	...
	public void showPickTasks() {
		...
		List<WebElement> closeAction = driver.findElements(By.cssSelector("#closeAction1 > span > span"));
		List<WebElement> partialPickAction = driver.findElements(By.cssSelector("#partialPickAction > span > span"));
	    ...
	    Assert.assertTrue(closeAction.get(5).isEnabled());
	    Assert.assertTrue(partialPickAction.get(5).isEnabled());
	    Assert.assertTrue(fullPickAction.get(5).isEnabled());
