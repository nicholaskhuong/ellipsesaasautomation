package com.abb.ventyx.saas.quickissue;
...
public class QuickIssue_Steps03_04 extends BaseTestCase {
	 WebDriver drv;
	...
	public void showPickTasks() {
		...
		Assert.assertEquals(documentNumber.get(0).getAttribute("value"),"B00710");
		...
		Assert.assertEquals(documentNumber.get(1).getAttribute("value"),"B01140");
		...
		Assert.assertEquals(documentNumber.get(2).getAttribute("value"),"D01081");
		...
		Assert.assertEquals(documentNumber.get(3).getAttribute("value"),"G01163");
