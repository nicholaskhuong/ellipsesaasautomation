...
public class BinLabel_Automatic_Steps05_08 extends BaseTestCase {
	...
	public void inputPurchaseOrderNumber() {
		...
		purchaseOrderNumber.sendKeys("P05102");
	}
	...
	public void inputPurchaseOrderItemNumber() {
		...
		screenAction.waitObjVisible(driver, By.id(POSearchPageDefinition.PO_ITEM_NUMBER_ID), 3);
	}
	...
	public void displayDetailItems() {
		...
		Assert.assertEquals(stockCode.get(0).getAttribute("value"), "STC87");
