...
public class BinLabel_Manual_And_UOI_Quantity_Steps05_09 extends BaseTestCase {
	...
	public void inputPurchaseOrderNumber() {
		...
		purchaseOrderNumber.sendKeys("P05103");
	}
	...
	@Test(description = "Display Items on PO Items", dependsOnMethods = "accessToPOItemsPage", alwaysRun = true)
	...
	@Test(description = "Input Receipt Qty On Item Detail Page", dependsOnMethods = "clickRECEIVEButton", alwaysRun = true)
	...
	@Test(description = "Click Receive Button after input Receipt Qty On Item Detail Page", dependsOnMethods = "inputReceiptQtyOnItemDetailPage", alwaysRun = true)
	public void clickRECEIVEButtonAfterInputQty() {
		screenAction.clickBtn(By.id(ItemDetailPageDefinition.RECEIVE_ID));
		screenAction.waitObjVisible(driver, By.id(ItemDetailPageDefinition.RECEIVE_ID), 3);
	}
	
	@Test(description = "Display Message On PO Item Page", dependsOnMethods = "clickRECEIVEButtonAfterInputQty", alwaysRun = true)
