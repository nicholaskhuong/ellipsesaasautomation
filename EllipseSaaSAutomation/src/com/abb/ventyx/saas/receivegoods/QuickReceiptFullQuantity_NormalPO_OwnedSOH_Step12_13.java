...
public class QuickReceiptFullQuantity_NormalPO_OwnedSOH_Step12_13 extends
		BaseTestCase {
	...
	public void clickRECEIVEButton() {
		...
		actionBtn.clickBtn(By
				.cssSelector(ItemDetailPageDefinition.RECEIVE_BUTTON_ID));
	}
	...
	public void displayMessageItemPage() {
		List<WebElement> lismg = driver.findElements(By
				.cssSelector(ItemDetailPageDefinition.MESSAGE_ERROR_TEXT_ID));
		Assert.assertEquals(lismg.get(0).getText(),
				"(ERROR) 3140.E0073: Bin Code Is Required");
		lismg.get(0).click();
	}
	...
	public void inputNewBinOnItemPage() {
		driver.findElement(By.id(ItemDetailPageDefinition.NEW_BIN_ID))
				.sendKeys("BIN5");
	}
